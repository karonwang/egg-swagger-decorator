...
declare const ignoreMiddlewareObjects = {};
declare const request: (method: any, path: any, ignoreMiddleware: boolean = false) => (target: any, name: any, descriptor: any) => any;
